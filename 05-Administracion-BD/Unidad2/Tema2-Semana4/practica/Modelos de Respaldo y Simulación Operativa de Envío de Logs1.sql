...
/* ======================================================================
   ...
   - Respaldos configurados: Cada 15 minutos (ej: 13:00, 13:15, 13:30).
   - Último respaldo exitoso: 13:00.
   - Siniestro (destrucción total): 13:14 con 59 segundos.
   - Tiempo de información perdida: 14 minutos y 59 segundos.
   > RPO Máximo de nuestro escenario: 15 minutos (es la ventana de pérdida garantizada).
