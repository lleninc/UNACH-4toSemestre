...
FROM DISK = 'C:\Backups\SistemaVentas_Full.bak'
WITH NORECOVERY;
GO
--SCRIPT: Restaurar el Backup DIFERENCIAL (Trae los datos del mediod�a)
RESTORE DATABASE SistemaVentas
FROM DISK = 'C:\Backups\SistemaVentas_Diff.bak'
WITH RECOVERY;
GO
...
TO DISK = 'C:\Backups\SistemaVentas_Log1.trn'
...
BACKUP LOG SistemaVentas
TO DISK = 'C:\Backups\SistemaVentas_Log2.trn'
